...
export default function Analytics() {
  ...
  return (
    <div style={s.pageWide}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, minmax(110px, 180px))', gap: 5, marginBottom: 8 }}>
        {TABS.map(([k, label]) => (
...
function Turnover() {
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(90px, 160px))', gap: 5, margin: '12px 0' }}>
      ...
      <div style={s.cardGrid}>
        {slow.map((r, i) => (
          <div key={i} style={{ ...s.card, marginBottom: 0, borderTop: `3px solid ${C.chili}` }}>
            <div style={s.rowBetween}>
              <div style={s.code}>{r.code}</div>
    ...
    <>
      ...
      <div style={s.cardGrid}>
        {active.map((a) => {
          ...
          return (
            <div key={a.id} style={{ ...s.card, marginBottom: 0, borderTop: `3px solid ${stale ? C.amber : C.neo}` }}>
              <div style={s.rowBetween}>
      ...
      <div style={s.cardGrid}>
        {team.map((t) => (
          <div key={t.task_type} style={{ ...s.card, marginBottom: 0 }}>
            <div style={s.rowBetween}>
    ...
    <>
      ...
      <div style={s.cardGrid}>
        {trusted.filter((r) => r.needs_reorder).map((r) => (
          <div key={r.code} style={{ ...s.card, marginBottom: 0, borderTop: `3px solid ${C.chili}` }}>
            <div style={s.rowBetween}>
              <div style={s.code}>{r.code}</div>
...
function Sync() {
  ...
  return (
    <>
      ...
      <div style={s.cardGrid}>
        {health.map((h) => (
          <div key={h.endpoint} style={{ ...s.card, marginBottom: 0, borderTop: `3px solid ${h.dead > 0 ? C.chili : h.failed > 0 ? C.amber : C.neo}` }}>
            <div style={s.rowBetween}>
      ...
      <button style={{ ...s.btnGhost, width: '100%', maxWidth: 320, marginTop: 8 }} disabled={busy}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(90px, 160px))', gap: 5, margin: '14px 0 8px' }}>
